    ...
    <section id="services" className="section-padding bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-ocean-base/70 max-w-xl mx-auto text-lg">
            From basic cleaning to full custom builds — we take care of every drop.
          </p>
          <div className="inline-block mt-5 px-5 py-2 rounded-full text-sm font-medium text-ocean-deep"
          ...
          {services.map((service, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-display font-semibold text-xl text-ocean-dark mb-3 leading-snug">
                  {service.title}
                </h3>
                <p className="text-ocean-base/75 text-sm leading-relaxed">
                  {service.description}
                </p>
