    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          <AnimatePresence>
            {tooltip && (
              <motion.div
                ...
                exit={{ opacity: 0, x: 20 }}
                className="bg-white text-ocean-dark text-sm font-medium px-4 py-2 rounded-2xl shadow-aqua-md whitespace-nowrap"
          ...
          {/* Button wrapper — keeps pulse ring behind the button */}
          <div className="relative w-14 h-14">

            {/* Pulse ring — behind, cannot block clicks */}
            <div
              className="absolute inset-0 w-14 h-14 rounded-full animate-ping pointer-events-none"
